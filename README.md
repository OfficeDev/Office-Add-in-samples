...
| [Verify the sensitivity label of a message (preview)](Samples/outlook-check-item-categories/) | Uses the sensitivity label API in an event-based add-in to verify and apply the **Highly Confidential** sensitivity label to applicable outgoing messages. |

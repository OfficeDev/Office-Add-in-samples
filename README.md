...
| [Word Tutorial - Completed](Samples/tutorials/word-tutorial) | This sample is the completed version of the [Tutorial: Create a Word task pane add-in](https://learn.microsoft.com/office/dev/add-ins/tutorials/word-tutorial) that shows how to create a Word add-in with a task pane and command ribbon buttons. The add-in shows how to insert a range of text, format text, replace text, insert images, HTML, and tables, and create and update content controls. |

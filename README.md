...
| [Synchronous custom function conditional formatting (preview)](Samples/excel-custom-functions-sync-conditional-format) | Use a synchronous custom function in a conditional format rule to highlight cells that exceed a target value. |

...
async function callWebServerAPI(method, path, retryRequest = false) {
    // TODO 2: Get access token, then make fetch call to the server REST API.

    // TODO 3: Check for expired SSO token.

    // TODO 4: Check for Microsoft Graph errors.

    // TODO 5: Check for other errors.
...
async function getAccessToken(authSSO) {
    // TODO 6: Attempt to get an access token using SSO.

 ...
 const msalConfig = {
    auth: {
      ...
      authority: "https://login.microsoftonline.com/common", // Defaults to "https://login.microsoftonline.com/common"
         redirectUri: "https://localhost:7283/dialog.html", // You must register this URI on Azure Portal/App Registration. Defaults to window.location.href
      //postLogoutRedirectUri: "https://localhost:7283/signout", // Simply remove this line if you would like navigate to index page after logout.

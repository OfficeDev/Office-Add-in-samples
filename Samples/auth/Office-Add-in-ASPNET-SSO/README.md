...
- Build an add-in using ASP.NET Core and Office.js.
- Use the MSAL Library to implement the OAuth 2.0 authorization framework in an add-in.
...
2.3 | July 29, 2022 | Updated to use ASP.NET Core and latest MSAL library.

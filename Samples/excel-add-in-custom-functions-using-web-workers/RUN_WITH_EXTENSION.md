...
- The `./src/functions/functions.js` file contains the Custom Function JavaScript code.
- The `./src/functions/functions-worker.js` file contains the Web Worker JavaScript code.

    ...
    internal class SpreadsheetBuilder
    {
        ...
        */
        ...
        private void GenerateWebExtensionPart1Content(WebExtensionPart webExtensionPart1)
        {
            ...
            // Uncomment the following lines if your add-in is deployed through central deployment (not AppSource).
            // We.WebExtensionStoreReference webExtensionStoreReference1 = new We.WebExtensionStoreReference() { Id = "<Your add-in GUID>", Version = "1.0.0.0", Store = "excatalog", StoreType = "excatalog" };
            // We.WebExtensionStoreReference webExtensionStoreReference2 = new We.WebExtensionStoreReference() { Id = "<Your add-in GUID>", Version = "1.0.0.0", Store = "omex", StoreType = "omex" };            

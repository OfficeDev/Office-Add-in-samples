...
function launch_feedback_window()
{
  window.open("https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbRzpdHui3E9lAjPPxV70z3exUQ0dCUFNTOEdSTTZHNzhPTzJMOTExNU1VWi4u");
  display_message("A browser window should open up with a feedback form.");
}
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Excel.JsonToOfficeTableWeb.App.Default" %>
    <!DOCTYPE html>
    ...
    <body>
        ...
        <img src="https://pnptelemetry.azurewebsites.net/pnp-officeaddins/samples/Excel.JsonToOfficeTable-run" />
            ...
            <div style="width: 100%;">
                ...
                <div id="content">
                    <div id="content1" class="content">
                        ...
                        <p>This sample makes a client-side REST call to get stock data and populate a table in the Excel
                            workbook.</p>
                        <h3>Stock Symbol:</h3>
                    ...
                    <div id="content2" class="content">
                        ...
                        <p>This sample performs a post-back to get stock data server-side, which is returned as script
                            on the page that is used to populate a table in the Excel workbook.</p>
                        <h3>Stock Symbol:</h3>

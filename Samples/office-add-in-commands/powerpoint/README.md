...
1.  Browse to the add-in manifest file, and then select **Upload**.
    ...
    ![The upload add-in dialog with buttons for browse, upload, and cancel.](Samples/images/office-add-ins-excel-web.png)
...
<img src="https://telemetry.sharepointpnp.com/pnp-officeaddins/samples/excel-add-in-commands" />
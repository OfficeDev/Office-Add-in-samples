...
async function addInformation() {
  await Excel.run(async (context) => {
    ...
    category.fill.foregroundColor = "#003366";
    ...
    subCategory.fill.foregroundColor = "#003366";
    ...
    maxSale.fill.foregroundColor = "#FF6600";
    ...
    sumSale.fill.foregroundColor = "#FF6600";

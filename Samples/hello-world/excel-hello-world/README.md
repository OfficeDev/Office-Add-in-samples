...
**Note:** The taskpane.html file contains an image URL that tracks diagnostic data. Please remove the image tag if you reuse this sample in your own code project.

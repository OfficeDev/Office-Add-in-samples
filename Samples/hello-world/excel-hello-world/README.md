...
Now that your localhost web server is running, you can sideload the manifest-localhost.xml file provided in the word-hello-world folder. Follow the steps in [Run the sample on Excel on web](#run-the-sample-on-excel-on-web) to sideload and run the add-in.

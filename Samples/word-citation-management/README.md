...
1. Start the local web server and sideload your add-in.
    ...
    - To test your add-in in Word on the web, run the following command in the root directory of the `word-citation-management` project. When you run this command, the local web server starts. Replace "{url}" with the URL of a Word document on your OneDrive or a SharePoint library to which you have permissions.

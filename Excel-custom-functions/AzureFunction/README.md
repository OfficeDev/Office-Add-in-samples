...
1. In the **Azure: Functions** area, expand the new function app under your subscription. Expand **Functions**, select and hold (or right-click) **AddTwo**, and then choose **Copy function URL**.
...
1. Open the Azure portal and sign in. You can do this by selecting the Azure icon on the Activity bar in Visual Studio Code. Then select and hold (or right-click) your Azure subscription for the Azure Function and choose **Open in Portal**.

...
function sum() {
  ...
  // Examples
  console.clear();
  sum(1, 2).then((value) => { console.log("1 + 2 = " + value); });
  mul(1, 2).then((value) => { console.log("1 * 2 = " + value); });
  sum(2, 4, 6).then((value) => { console.log("2 + 4 + 6 = " + value); });
  mul(2, 4, 6).then((value) => { console.log("2 * 4 * 6 = " + value); });

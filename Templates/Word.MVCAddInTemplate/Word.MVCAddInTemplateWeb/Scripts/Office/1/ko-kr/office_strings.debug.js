...
Strings.OfficeOM.L_RunMustReturnPromise = '".run" 메서드에 전달된 일괄 처리 함수가 약속을 반환하지 않았습니다. 함수에서 약속을 반환해야만 일괄 처리 작업 완료 시 자동으로 추적되는 개체가 해제될 수 있습니다. 일반적으로 "context.sync()"의 응답을 반환하여 약속을 반환합니다.';
...
Strings.OfficeOM.L_DialogAddressNotTrusted = "지정한 주소는 추가 기능에서 신뢰하지 않습니다.";

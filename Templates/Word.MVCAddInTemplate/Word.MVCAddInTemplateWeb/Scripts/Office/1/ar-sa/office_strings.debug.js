...
Strings.OfficeOM.L_RunMustReturnPromise = 'لم ترجع الوظيفة الدفعية التي تم تمريرها إلى أسلوب ".run" أي التعهد. يجب أن تُرجع الوظيفة أي تعهد، بحيث يمكن إصدار أي كائنات يتم تعقبها تلقائياً عند اكتمال العملية الدفعية. عادةً، يمكن إرجاع التعهد بإرجاع الاستجابة من"context.sync()".';
...
Strings.OfficeOM.L_InvalidRequestContext = "لا يمكن استخدام الكائن عبر سياقات طلب مختلفة.";
...
Strings.OfficeOM.L_DialogAddressNotTrusted = "لم يتم توثيق العنوان المحدد بواسطة الوظيفة الإضافية";
...
Strings.OfficeOM.L_InvalidObjectPath = 'لا يعمل مسار الكائن "{0}" لما تحاول القيام به. إذا كنت تستخدم الكائن عبر عدة استدعاءات "context.sync" وخارج التنفيذ المتسلسل لدفعة "‎.run"، يرجى استخدام الأسلوبين "context.trackedObjects.add()‎" و"context.trackedObjects.remove()‎" لإدارة مدة بقاء الكائن.';
...
Strings.OfficeOM.L_PropertyNotLoaded = "الخاصية '{0}' غير متاحة. قبل قراءة قيمة الخاصية، قم باستدعاء أسلوب التحميل على الكائن المضمن وقم باستدعاء \"context.sync()‎\" في سياق الطلب المقترن.";

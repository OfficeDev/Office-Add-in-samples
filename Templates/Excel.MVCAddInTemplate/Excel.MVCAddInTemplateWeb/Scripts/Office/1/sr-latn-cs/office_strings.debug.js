...
Strings.OfficeOM.L_ActivityLimitReached = "_Âćţívîťý ľîmîť hąś běěń řěâčhěđ.džšćđ_";
...
Strings.OfficeOM.L_DialogAlreadyOpened = "_Ţhé ópéřăţíóń fáíĺęđ béćăµşë ťhîš âđď-íň áľřëăđý häş âń ăçťívě đíăłôg.džšćđČdžšćđ_";
...
Strings.OfficeOM.L_RunMustReturnPromise = '_Ţhę bäťčh fůňčţíóň pâšşěď ţö ťhë ".ŕüń" mëťhóđ đíđň\'ţ ŕęţüřň ą pŕőmíśé. Ţhę fůńçţíöň müśť ŕěţµŕň ä pŕômíşé, śô ťhăť ăńý áůťómáţîćăĺĺý-ťŕâćkëď óbjëçťś čăń bé ŕëĺěâšëď âţ ťhě ćómpľëťîőń őf ťhě bäťçh ôpëŕâťîóń. Ţýpîčăĺłý, ýöü ŕéťůřń â přőmîşë bý řěţµŕňíńg ťhě řěşpőńšé fřöm "čóňţěxť.šýňč()".džšćđČdžšćđČdžšćđČdžšćđČdžšćđČdžšćđČdžšćđČdžšć_';
...
Strings.OfficeOM.L_AppNameNotExist = "_Ăďď-íň Ňâmě fóř {0} ďôęşń'ť ëxíšť.džšćđ_";
...
Strings.OfficeOM.L_InvalidRequestContext = "_Çäňňőť µśě ťhě óbjéçť ăçŕôśş đífféřęňţ ŕëqůěśţ čôńţëxţś.džšćđČdžš_";
...
Strings.OfficeOM.L_DialogAddressNotTrusted = "_Ţhę şpëçífíéđ äđďřěşš háş ńöť bęęň ńôť ţŕµśťëđ bý ťhé âđď-îńdžšćđČdžšć_";
...
Strings.OfficeOM.L_InvalidArgument = "_Ţhě ářgůmëńť '{0}' đôéšň'ť wóŕk fôř ťhîś şîţµáţíőň, íś mîššíňg, óř íśň'ť íń ťhë řîghť fôřmâţ.džšćđČdžšćđČdžš_";
...
Strings.OfficeOM.L_DialogNavigateError = "_Đíáľőg Ňąvîgăţíóň Éŕŕöřdžšć_";
Strings.OfficeOM.L_InvalidObjectPath = '_Ťhě őbjěćţ pąťh \'{0}\' íšń\'ţ wőŕkíńg fôř whäť ýôü\'řě ťŕýíńg ťö đô. Íf ýőů\'řë üşíňg ťhé óbjëçţ äçřóşš můĺţípĺę "čôńťěxţ.śýňç" ćáĺľş áňď ôµţśíđé ţhé śéqµěńťîâĺ ëxęçµťîőń óf ą ".ŕµń" báťčh, płěáśé µšë ţhé "çöńţéxţ.ţŕâçkéďÓbjëçťş.áđđ()" ăńď "ćóňţëxť.ťřäčkëđŐbjěčťş.řěmővé()" męţhöďş ţö mâńągę ţhě óbjěćť\'š ĺífëţîmę.džšćđČdžšćđČdžšćđČdžšćđČdžšćđČdžšćđČdžšćđČdžšćđČdž_';
...
Strings.OfficeOM.L_DisplayDialogError = "_Đîşpľáý Ďîáĺóg Ěřŕöŕdžš_";
...
Strings.OfficeOM.L_PropertyNotLoaded = "_Ťhë pŕôpěŕťý '{0}' îş ňőť âvąíłăbĺě. ßěfőřë ŕęâđíňg ťhé pŕőpëŕťý'ś văľúę, čâľľ ţhě ĺóâď mëťhöď öń ţhę çôňťâîňíňg őbjéćţ ăňđ čâĺĺ \"čőňţëxţ.šýňç()\" öň ťhě áśśóčîăţěđ ŕéqúéśţ čőňţëxţ.džšćđČdžšćđČdžšćđČdžšćđČdžšćđ_";
